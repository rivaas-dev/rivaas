...
[![Go Reference](https://pkg.go.dev/badge/rivaas.dev/router/middleware/bodylimit.svg)](https://pkg.go.dev/rivaas.dev/router/middleware/bodylimit)
...
```bash
go get rivaas.dev/router/middleware/bodylimit
```
