...
// TestContextCancellationInStart tests that Start handles cancelled contexts.
...
// TestContextCancellationInCustomMetrics tests that custom metrics returns error with cancelled context
