...
// This is the opaque token passed between lifecycle methods.
...
// Implements router.ResponseInfo plus common optional interfaces.
...
// Preserve io.ReaderFrom (for efficient io.Copy)
func (rw *observabilityResponseWriter) ReadFrom(r io.Reader) (int64, error) {
	// Try to use underlying ReaderFrom implementation if available (more efficient)
