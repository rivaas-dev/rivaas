...
//   - You need quick development with sensible defaults
...
//   - Maximum performance is critical (app adds ~1-2% latency overhead)
...
//     and is useful for fail-fast initialization in main() functions.
//
...
//	}
//
// Or using MustNew for fail-fast initialization:
//
//	app := app.MustNew(
...
//
//   - OnStart: Called before server starts (sequential, fail-fast)
