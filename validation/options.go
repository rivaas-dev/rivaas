...
// When enabled with WithRunAll(true), validation succeeds if at least one strategy
// produces no errors, even if other strategies fail.
//
// This is useful when you have multiple validation strategies and want to accept
