...
require (
	...
	gitlab.ci.fdmg.org/ci-api/go-pkgs/keycloak v1.5.0
	gitlab.ci.fdmg.org/ci-api/oma v0.4.1
	gitlab.ci.fdmg.org/ci-api/tyk-sdk-go v0.1.0
	gitlab.ci.fdmg.org/datacluster/golibs/gnatcatcher v0.1.5
	gitlab.ci.fdmg.org/datacluster/golibs/goot v0.1.1
	gitlab.ci.fdmg.org/datacluster/golibs/goskell v1.8.2
	gitlab.ci.fdmg.org/datacluster/nl/webservices/goconfig v1.1.1
