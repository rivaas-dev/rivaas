		...
		tests := []struct {
		...
		}{
			{
				...
				setup: func() (*prefixGetter, url.Values) {
					...
					getter := NewQueryGetter(values).(*QueryGetter)
		...
		tests := []struct {
		...
		}{
			{
				...
				setup: func() (*prefixGetter, url.Values) {
					...
					values.Set("title", "Mr")
					getter := NewFormGetter(values).(*FormGetter)
		...
		tests := []struct {
		...
		}{
			{
				...
				setup: func() (*prefixGetter, string, bool) {
					...
					getter := NewHeaderGetter(headers).(*HeaderGetter)
			...
			},
			{
				...
				setup: func() (*prefixGetter, string, bool) {
					...
					getter := NewParamsGetter(params).(*ParamsGetter)
			...
			},
			{
				...
				setup: func() (*prefixGetter, string, bool) {
					...
					getter := NewCookieGetter(cookies).(*CookieGetter)
