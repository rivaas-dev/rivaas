...
[![Go Reference](https://pkg.go.dev/badge/rivaas.dev/router/middleware/basicauth.svg)](https://pkg.go.dev/rivaas.dev/router/middleware/basicauth)
...
```bash
go get rivaas.dev/router/middleware/basicauth
```
