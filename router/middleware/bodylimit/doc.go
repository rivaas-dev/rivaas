...
// # Performance
//
// Body limiting adds minimal overhead (~100ns) for requests within the limit.
// Requests exceeding the limit are rejected early, saving bandwidth and processing time.
package bodylimit
