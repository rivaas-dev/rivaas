...
// # Performance
//
// Timeout enforcement adds minimal overhead (~50ns) per request. The timeout
// is enforced using context.WithTimeout, which is efficient and standard Go practice.
package timeout
